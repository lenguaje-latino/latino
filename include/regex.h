...
REGEX_DLL_IMPEXP const char *
re_compile_pattern(const char *__pattern, size_t __length,
...
REGEX_DLL_IMPEXP int re_search(struct re_pattern_buffer *__buffer,
...
REGEX_DLL_IMPEXP int re_match(struct re_pattern_buffer *__buffer,
                              const char *__string, int __length, int __start,
...
REGEX_DLL_IMPEXP size_t regerror(int __errcode,
